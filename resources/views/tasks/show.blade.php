...
@section('page-title')
    <h2 class="mb-0">
        <i class="bi-check2-square me-2" style="color:#6366F1; font-size:2rem; vertical-align:-0.2em;"></i>
        <span style="font-weight:500;">Task<span style="color:#6366F1;">Detail</span></span>
    </h2>
@endsection
