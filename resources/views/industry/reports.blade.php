...
@section('content')
<h2 class="mb-4"><i class="bi bi-file-earmark-text"></i> Report <span class="brand-highlight">List</span></h2>
        ...
        <table class="table align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- View Button -->
                        <button class="btn btn-sm btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#viewReportModal{{ $report->id }}">
                            <i class="bi bi-eye"></i>
                        </button>
                        <!-- Edit Button: Only enabled if feedback is not given yet -->
                        @if(!$report->industry_feedback)
                            <button class="btn btn-sm btn-warning rounded-pill" data-bs-toggle="modal" data-bs-target="#feedbackModal{{ $report->id }}">
          ...
          <div class="modal-body">
            <div class="row mb-3">
                <div class="col-md-8">
                    ...
                    <p>
                        <strong class="text-primary">Date:</strong> {{ $report->report_date }}<br>
                        <strong class="text-primary">Task:</strong> {{ $report->task }}<br>
